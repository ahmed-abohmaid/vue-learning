  ...
  if (jobId) {
    ...
    axios
      ...
      .then((res) => {
        ...
        job.company.name = res.data.company.name;
        job.company.description = res.data.company.description;
        job.company.contactEmail = res.data.company.contactEmail;
        job.company.contactPhone = res.data.company.contactPhone;
      })
      .catch((error) => {
        console.log(error);
      })
